...
## Data Privacy & AI
For every Copywriter at BYU-Idaho, understanding data privacy is a crucial step to using GenAI ethically and safely. It is important to use your official account when sharing any personal information because GenAI tools train on data from personal chats otherwise. 

BYU-Idaho is committed to safeguarding your privacy and intellectual property. Your official `@byui.edu` account gives you access to authorized AI tools, each approved with a specific data classification levels: *public*, *internal*, *confidential*, and *restricted*. 
...
## Plagiarism & AI
* Difference between plagiarism, copyright infringement, and poor attribution.
* Why plagiarism applies to ideas and expression—not only exact wording.
* How AI Complicates Plagiarism
  * AI-generated text may reproduce phrases, structures, or ideas from training data.
  * Users may not know the original source of generated content.
  * AI can obscure authorship and make copied language appear original.
...
### BYU-Idaho & Copyright Law

### AI-Specific Copyright Risk Factors
