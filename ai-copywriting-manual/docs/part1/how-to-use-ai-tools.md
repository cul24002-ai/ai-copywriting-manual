...
|:--:|:--:|:--|:--|
| ChatGPT Edu | OpenAI | Requires CES Edu license. Must use your ChatGPT BYU-Idaho institutional account. | [Access ChatGPT](https://chatgpt.com/)|
| Microsoft Copilot | Microsoft AI | Must use your Microsoft BYU-Idaho institutional account. | [Access Microsoft Copilot](https://copilot.microsoft.com/)|
| Google Gemini | Google AI | Must use your Gemini BYU-Idaho institutional account. | [Access Google Gemini](https://gemini.google.com/app)|
